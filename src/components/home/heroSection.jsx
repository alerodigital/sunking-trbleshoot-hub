        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mx-auto w-700">
            <div className="relative flex items-center bg-white rounded-md border border-gray-300 shadow-sm h-60-custom gap-2">
              ...
              <button
                type="button"
                className="absolute right-2 w-101 h-42 py-2 px-6 cursor-pointer rounded-full text-sm font-medium text-black bg-[#F6D852] hover:bg-[#F0C040] focus:outline-none transition-colors duration-200"
              >
                Search
              </button>
            </div>
